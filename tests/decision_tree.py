...
# Calcul de l'impureté de Gini pour une variable continue
...
# Calcul de l'information gain pour une variable continue
...
# Calcul du meilleur split pour une variable
...
# Choisir le meilleur split pour une variable

data.drop('obese', axis= 1).apply(max_information_gain_split, y = data['obese'])

# Déterminer le meilleur split pour une variable
...
# Prédire avec un arbre de décision
...
print(clasificar_datos(data.iloc[0], decisiones))